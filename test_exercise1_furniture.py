...
def _truncate(t: Decimal) -> Decimal:
    return t.quantize(Decimal('0.01'), decimal.ROUND_HALF_UP)
...
_test_data_valid_input=[
    ...
    pytest.param(Decimal("0.01"),date(2022,11,26),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="7"),
    pytest.param(Decimal("0.01"),date(2022,12,24),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="8"),
    ...
    pytest.param(Decimal("0.02"),date(2022,11,26),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="15"),
    pytest.param(Decimal("0.02"),date(2022,12,24),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="16"),
    ...
    pytest.param(Decimal("99.98"),date(2022,11,26),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="23"),
    pytest.param(Decimal("99.98"),date(2022,12,24),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="24"),
    ...
    pytest.param(Decimal("99.99"),date(2022,11,26),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="31"),
    pytest.param(Decimal("99.99"),date(2022,12,24),_truncate(Decimal("0.05")+Decimal("0.1")-(Decimal("0.05")*Decimal("0.1"))),id="32"),
    ...
    pytest.param(Decimal("100.00"),date(2022,11,26),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="39"),
    pytest.param(Decimal("100.00"),date(2022,12,24),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="40"),
    ...
    pytest.param(Decimal("100.01"),date(2022,11,26),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="47"),
    pytest.param(Decimal("100.01"),date(2022,12,24),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="48"),
    ...
    pytest.param(Decimal("499.98"),date(2022,11,26),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="55"),
    pytest.param(Decimal("499.98"),date(2022,12,24),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="56"),
    ...
    pytest.param(Decimal("499.99"),date(2022,11,26),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="63"),
    pytest.param(Decimal("499.99"),date(2022,12,24),_truncate(Decimal("0.1")+Decimal("0.1")-(Decimal("0.1")*Decimal("0.1"))),id="64"),
    ...
    pytest.param(Decimal("500.00"),date(2022,11,26),_truncate(Decimal("0.2")+Decimal("0.1")-(Decimal("0.2")*Decimal("0.1"))),id="71"),
    pytest.param(Decimal("500.00"),date(2022,12,24),_truncate(Decimal("0.2")+Decimal("0.1")-(Decimal("0.2")*Decimal("0.1"))),id="72"),
    ...
    pytest.param(Decimal("500.01"),date(2022,11,26),_truncate(Decimal("0.2")+Decimal("0.1")-(Decimal("0.2")*Decimal("0.1"))),id="79"),
    pytest.param(Decimal("500.01"),date(2022,12,24),_truncate(Decimal("0.2")+Decimal("0.1")-(Decimal("0.2")*Decimal("0.1"))),id="80"),]
